...
export default function PublicLanding({onAuthenticate}:Props){
  ...
  return <div className="public-shell">
    ...
    {route==='enterprise'?<EnterprisePage onAuthenticate={onAuthenticate} onHome={home}/>:content?<PublicContentPage slug={route} onAuthenticate={onAuthenticate} onHome={home}/>:<>
    <main id="top">
      ...
      <section id="capabilities" className="public-section">
        ...
        <div className="public-grid three"><article><span>01</span><h3>Plan before changing code</h3><p>Turn a prompt into architecture, scope and executable steps before implementation starts.</p></article><article><span>02</span><h3>Build with verification</h3><p>Generate and iterate on real code with preview, tests, security checks and recoverable versions.</p></article><article><span>03</span><h3>Own the outcome</h3><p>Connect GitHub, integrations and deployment while keeping governance and engineering evidence visible.</p></article></div>
      </section>
